...
class HyperShopContentModel extends ModelBase {
  HyperShopContentModel({this.code,this.name,this.unit,this.currency,this.categoryCode,this.category,this.status,this.image,this.memo,this.price,this.salePrice,this.count,this.discount,this.shortDetails,this.description,this.isNewPro,this.brand,this.sale,this.tags,this.colors,this.measurement,this.rowId});
  ...
  static HyperShopContentModel fromJsonObject(Object value) => HyperShopContentModel.fromJson(value);
